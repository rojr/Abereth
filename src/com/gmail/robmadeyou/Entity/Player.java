...
public class Player extends Entity {
    ...
    public void draw() {
        ...
        if (targetedEnemy != null) {
            ...
            int eTexture = targetedEnemy.getTexture();
            Collector.add(new DrawParameters("box", x2, y2, width2, height2, eTexture, Color.Red, 1, layer, true, false));
        }

        Collector.add(new DrawParameters("box", x, y, width, height, texture, color, 1, layer, true, false));
    }
