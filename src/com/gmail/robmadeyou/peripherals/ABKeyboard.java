...
public class ABKeyboard {
    ...
    public static boolean isKeyPressed(ABKey key) {
        isKeyDown(key);
        return key.isPressed;
    }

    public static boolean isKeyDown(ABKey key) {
    ...
    public static enum ABKey {

        UpArrow(org.lwjgl.input.Keyboard.KEY_UP, false, false),
        DownArrow(org.lwjgl.input.Keyboard.KEY_DOWN, false, false),
        LeftArrow(org.lwjgl.input.Keyboard.KEY_LEFT, false, false),
        RightArrow(org.lwjgl.input.Keyboard.KEY_RIGHT, false, false),
        ...
        Q(org.lwjgl.input.Keyboard.KEY_Q, false, false),
        W(org.lwjgl.input.Keyboard.KEY_W, false, false),
        E(org.lwjgl.input.Keyboard.KEY_E, false, false),
        R(org.lwjgl.input.Keyboard.KEY_R, false, false),
        T(org.lwjgl.input.Keyboard.KEY_T, false, false),
        Y(org.lwjgl.input.Keyboard.KEY_Y, false, false),
        U(org.lwjgl.input.Keyboard.KEY_U, false, false),
        I(org.lwjgl.input.Keyboard.KEY_I, false, false),
        O(org.lwjgl.input.Keyboard.KEY_O, false, false),
        P(org.lwjgl.input.Keyboard.KEY_P, false, false),
        A(org.lwjgl.input.Keyboard.KEY_A, false, false),
        S(org.lwjgl.input.Keyboard.KEY_S, false, false),
        D(org.lwjgl.input.Keyboard.KEY_D, false, false),
        F(org.lwjgl.input.Keyboard.KEY_F, false, false),
        G(org.lwjgl.input.Keyboard.KEY_G, false, false),
        H(org.lwjgl.input.Keyboard.KEY_H, false, false),
        J(org.lwjgl.input.Keyboard.KEY_J, false, false),
        K(org.lwjgl.input.Keyboard.KEY_K, false, false),
        L(org.lwjgl.input.Keyboard.KEY_L, false, false),
        Z(org.lwjgl.input.Keyboard.KEY_Z, false, false),
        X(org.lwjgl.input.Keyboard.KEY_X, false, false),
        C(org.lwjgl.input.Keyboard.KEY_C, false, false),
        V(org.lwjgl.input.Keyboard.KEY_V, false, false),
        B(org.lwjgl.input.Keyboard.KEY_B, false, false),
        N(org.lwjgl.input.Keyboard.KEY_N, false, false),
        M(org.lwjgl.input.Keyboard.KEY_M, false, false),
        ...
        ABKey(int number, boolean isPressed, boolean isReleasedAfterPressed) {
            this.number = number;
