...
public class Emitter3 {
    ...
    public Emitter3(double x, double y, int amount, float size, double velocity, int spawnRate, Color color) {
        this.drawType = 0;
        this.x = x;
        this.y = y;
    ...
    public Emitter3(double x, double y, int amount, float size, double velocity, int spawnRate, Color color, int texID) {
        this.drawType = 1;
        this.x = x;
        this.y = y;
        this.velocity = velocity;
    ...
    public Emitter3(double x, double y, int amount, float size, double velocity, int spawnRate, Color color, ArrayList<Integer> textureList) {
        this.drawType = 2;
        this.x = x;
        this.y = y;
        this.velocity = velocity;
