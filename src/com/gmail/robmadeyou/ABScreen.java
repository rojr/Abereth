...
public class ABScreen {
    ...
    public static void create(int dimensionX, int dimensionY, String name, GameType typeOfGame, boolean Minimalistic) {
        ...
        ABTextures.setUpTextures();
        System.out.println(engineName + "Textures set up: " + ABTextures.texSetUp);
    ...
    public static void setUpWorld() {
        ...
        ABWorld.setWorldDimensions(WorldWidth, WorldHeight);
        try {
            ABWorld.setArrayListClear();
    ...
    public static void update(int rate) {
        ...
        updateFPS();
        delta = getDelta();
        Abereth.islmbpThisTick = false;
        Abereth.isrmbpThisTick = false;
        ...
        Abereth.update(delta);
        ABUI.onUpdate();
        if (ABKeyboard.isKeyPressed(ABKey.Grave)) {
